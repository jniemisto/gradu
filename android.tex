...
Sovelluksen ja testien kehitysaikaista ajamista varten SDK:n mukana tulee Android-emulaattori. Emulaattoreita voi ajaa Androidin eri järjestelmäversioilla ja laitteistoprofiileilla, jotta on mahdollista testata sovelluksen toimivuutta erilaisissa Android-ympäristöissä. Emulaattori kykenee myös jossain määrin simuloimaan lisälaitteiden, kuten kiihtyvyysanturin, toimintaa. Suurin puute emulaattorissa on sen heikko suoritusnopeus. Sovelluksia ja testejä voi ajaa kehitystyökalusta myös suoraan tietokoneeseen liitetyssä Android-laitteessa. 
...
Eclipsessä Android-projektin aloittaminen luo sovelluksen perusrakenteen valmiiksi, joten sovellusta pääsee suoraan ohjelmoimaan ilman konfigurointia. Itse sovelluksen ohjelmointi taas on pääosin kuin tekisi mitä tahansa Java-ohjelmaa. Ohjelmaa voi ajaa suoraan Eclipsestä emulaattorissa tai Android-laitteessa. Tällöin Eclipse kääntää ja paketoi sovelluksen ja asentaa sen kohdelaitteeseen. Testejä ajettaessa prosessi on sama: sovellus käännetään, paketoidaan ja asennetaan kohdelaitteeseen, jonka jälkeen testit ajetaan ja testien tulokset näkyvät Eclipsessä, kuten tavallisessakin Java-ohjelmassa. Etenkin testejä ajaessa asennussyklejä tulee siis jatkuvasti, mikä hidastaa testausta.
